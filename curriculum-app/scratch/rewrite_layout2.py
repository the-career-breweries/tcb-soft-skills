...
# 2. Extract the lms-container replacing it cleanly
start_idx = content.find('<div className="lms-container">')
# We need to find the matching closing div of lms-container
# Actually, the lms-container is the last element inside the ternary.
# It ends with:
"""
        </div>
      </>
