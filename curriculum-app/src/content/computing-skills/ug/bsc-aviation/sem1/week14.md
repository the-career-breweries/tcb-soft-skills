...
- **Create strong passwords** — rules, examples, and what NOT to do
...
- Common Cyber Threats & Strong Passwords Explained

- Common cyber threats to know:


### 🔹 A Strong Password:
- Has at least 12 characters, mixes uppercase, lowercase, numbers and symbols, and is unique for every different site or account — reusing one password everywhere means one leak can compromise every account at once.

---

# 🧠 Key Concept

- Two-Factor Authentication & Online Meeting Etiquette

- Two-factor authentication (2FA) adds a second layer of protection to an account beyond just a password. It combines something known (the password) with something held (such as a one-time code sent to a phone). Even if a password is stolen, an attacker still cannot log in without also having that second item.

- Online meeting etiquette (Teams / Zoom):
...
3. Faculty shows 3 sample emails — mark each: Safe or Phishing — write reasons in your notes
4. Create Phishing_Red_Flags checklist in Word: urgent language, bad grammar, suspicious links, unknown sender, etc.
5. Settings  Windows Update — check if system is up to date (view only — don't install without permission)
6. Discuss: What is two-factor authentication (2FA)? — write 2 sentences in your notes
7. Browser: check padlock on 2 websites — one HTTP vs one HTTPS — note the difference
...
16. Lock PC demo: Win+L — log back in — discuss why this matters on shared computers
...
- Teams compete in 'Phishing or Legitimate?' — faculty shows 8 screenshots. Groups score points for correct answers. Winning team shares their top 3 red flags with the class.
...
- ☐ At least 1 Word doc (L04+), 1 Excel file (L07+), 1 PowerPoint (L11+)
- ☐ Lab13 cloud folder or email screenshot
- ☐ Lab14_Cyber_Safety_Pledge.docx with 8 rules
- ☐ Phishing_Red_Flags.docx with 10 red flags
- Present for 2-minute course recap: what was most useful?
...
4. Computer Basics: Creating a Safe Workspace
...
- https://www.youtube.com/watch?v=qTeZlPja5N4
